...
""" Область видимості це ланцюжок просторів імен, який починається від локального і триває до глобального чи 
вбудованого. Область видимості визначає те, в якому просторі імен Пайтон шукатиме визначення конкретного імені 
конкретної змінної та в якому порядку цеї пошук буде здійснюватись. Для пошуку є аривіатура LEGB. """
