...
# У Python існує безліч вбудованих функцій, які можна і потрібно використовувати для спрощення коду.
# print – функція виведення повідомлення в консоль.
# len – функція, яка повертає довжину об'єкта

# Функції перетворення типів – потрібні для того, щоб можна було створювати нові об'єкти певного типу.
