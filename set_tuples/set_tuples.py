# Множини – це структура даних, що не містить елементів, що повторюються. Багато не підтримують індексацію,
# тому доступ до елементів можливий перебором.
# Синтаксис множин:
# {1, 4, 2, 3}
print('Множини')
...
# В множину можна підставляти лише незмінні елементи:
# some_set2 = {['a', 'b'], {'a': 'a'}, 'a', 12, {1, 2, 3, 4}}  # => TypeError: unhashable type: 'list'
some_set2 = {'a', 12,}
...
some_frozen_set = frozenset('Frozen')  # Не можна редагувати та недоступні методи для редагування.
print(some_frozen_set)
print('~' * 50)

# Поняття кортежів
# Кортеж (tuple) – це постійний перелік.
# Синтаксис кортежів:
# (1, 2, 3) (1,)
print('Кортежі')
...
# Завдання 4
# Є рядок a = “a14b6fh”, як дізнатися, що всі символи унікальні, використовуючи множини та списки?
a = 'a14b6fh'
