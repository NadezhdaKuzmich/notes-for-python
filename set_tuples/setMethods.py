...
# pop() – видаляє перший елемент множини і повертає його. Так як множини не впорядковані,
# не можна точно сказати, який елемент буде першим.
print('pop:', some_set.pop())  # => 1
print('pop:', some_set)  # => {2, 3, 4, 5, 8, 'a'} але відповідь може бути й інша

# print(empty_set.pop())  # => KeyError: 'pop from an empty set'

# discard(elem) – видаляє елемент із множини, не повертає нічого (None) та не виводить помилок (None).
print('discard:', some_set.discard(8))  # => None
print('discard:', some_set)  # => {2, 3, 4, 5, 'a'}
# print(empty_set.discard('any'))  # => None

# remove(elem) – видаляє елемент із множини. Якщо такого елемента немає, видає помилку.
...
# difference(another_set) – різниця множин. Повертає різницю двох або більше множин у вигляді нової множини.
...
# print({1, 2} ^ [1, 2, 3])  # => (Видасть помилку) TypeError: unsupported operand type(s) for ^: 'set' and 'list'
