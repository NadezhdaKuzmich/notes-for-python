...
class Book(object):
    ...
    def __str__(self):
        return self.__as_string('"{}" by {} (published in {}, genre: {})')

    def __repr__(self):
        return self.__as_string("Book({!r}, {!r}, {!r}, {!r})")


def main():
    orwell1984 = Book('George Orwell', '1984', 1949,
                      'dystopia')
    orwell_copy = copy.copy(orwell1984)
    learning_python = Book('Mark Lutz', 'Learning Python',
                           2013, 'tutorial')
