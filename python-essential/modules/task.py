...
def get_max_count_word_combinations(words, max_count_word):
    ...
    max_count_word_combinations = [comb for comb in combinations if
                                   max_count_word in comb]
...
def process(txt):
    ...
    print(f'{max_count_word=}')

    max_count_word_combinations = get_max_count_word_combinations(
        words, max_count_word)
    print(f'{max_count_word_combinations=}')
...
text = ("blue cat is parked right behind the blue building with blue walls "
        "and red door")
rc = process(text)
print(rc)
