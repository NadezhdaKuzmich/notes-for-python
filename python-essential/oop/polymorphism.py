# Поліморфізм - різна поведінка одного й того методу в різних класах. Таким
# чином досягається додаткова гнучкість програми. А також, значно
# скорочується дублювання коду, що дуже важливо для хорошого та
# підтримуваного проекту. Поліморфізм досягається шляхом перевантаження чи
