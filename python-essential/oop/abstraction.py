# Абстракція - це спосіб представити кінцевий продукт таким чином,
# щоб користувачеві не потрібно було знати, як саме продукт працює,
# але користувач міг би їм легко користуватися. Основна ідея полягає в тому,
# щоб відокремити спосіб використання складових об'єктів даних від деталей
# їх реалізації у вигляді більш простих об'єктів..

# Абстракція в ООП - це приховування складності реалізації програмного
# продукту від кінцевого користувача шляхом створення простих і зрозумілих
# інтерфейсів (мова про так звані класи). Основну ідею абстракції можна
# легко переплутати з інкапсуляцією. Адже приховування даних користувача
