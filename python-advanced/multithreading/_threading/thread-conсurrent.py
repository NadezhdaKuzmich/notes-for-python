...
def run_by_executor_map(executor_class, max_workers=4):
    ...
    # використовуючи map, запускаємо функцію handler в результаті executor.map
    # поверне нам список результатів, який ми можемо підсумувати.
    # Зручніше, ніж executor.submit у тому випадку, якщо нам не потрібна футури
