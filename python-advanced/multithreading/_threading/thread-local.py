...
# ім'я поточного потоку (is deprecated)
# print(current.getName()) // error
# current.setName('SuperThread') // error
# print(current.getName()) // error

# Насправді setName, getName - це просто старий інтерфейс (is deprecated).
# У реальних завданнях ви можете працювати напряму з атрибутом name
...
# Напишемо приклад демонстрації потокобезопасного сховища даних.
...
def print_results():
    """
    Виконуючи цю функцію в різних потоках, ми помітимо, що сховище
    дійсно має різні значення в рамках кожного потоку - звідси і
    назва потокобезпечного сховища.
    :return:
    """
