...
test_value1 = generate_tuple(test_data1)  # type: List[Tuple[str, str]]
test_value2 = generate_tuple(test_data2)  # type: List[Tuple]
test_value3 = generate_tuple(test_data3)  # type: List
test_value4 = generate_tuple(test_data4)  # type: list
