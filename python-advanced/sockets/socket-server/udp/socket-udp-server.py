...
if __name__ == '__main__':
    # використовуємо оператор with для створення сервера на 0:8888 та запускаємо
    # with гарантує звільнення порту та коректне завершення роботи
    # сервер у класу реалізований `__enter__` / `__exit__`.
