...
class PersonTarget:
    ...
    def start(self, tag, attrib):
        # при вході в тег person, додаємо новий запис до списку,
        # який далі заповнюватимемо у методі data.
        if tag == 'person':
            self.records.append({
                'first_name': '',
                'last_name': '',
    ...
    def data(self, data):
        ...
        # перевіряємо поточний тег, якщо він є одним з тих, що нас цікавлять,
        # то беремо дані з тега і записуємо в елемент з індексом
        # self.current_index.
