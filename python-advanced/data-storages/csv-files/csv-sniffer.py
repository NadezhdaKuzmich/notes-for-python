...
# спроба відкрити файл і просканувати його вміст на визначення діалекту
# за допомогою Sniffer.
with open('data/undefined_dialect.csv', 'r') as f:
    content = f.read()
    # можна віддавати шматок файлу, не обов'язково весь,
    # все залежить від розміру файлу та порції даних, за якою sniffer зможе
    # визначити діалект.
    dialect = sniffer.sniff(content)

# виводимо отриманий результат, щоб переконатися, що роздільники та
# екранування коректно обчислені
