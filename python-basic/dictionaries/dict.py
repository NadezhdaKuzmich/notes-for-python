# Вбудованим класом відображення є dict, який реалізує таку структуру даних, як
# словник, або асоціативний масив, тобто невпорядковану змінювану колекцію пар
# (ключ, значення), яка підтримує довільний доступ до її елементів за їхніми
# ключами.
# Ключі словників мають бути хешованими значеннями.
