...
# використовувати для спрощення коду. print – функція виведення повідомлення
# в консоль. len – функція, яка повертає довжину об'єкта

# Функції перетворення типів – потрібні для того, щоб можна було створювати
# нові об'єкти певного типу. int - перетворення на ціле число
a_str = "10"
a_int = int(a_str)
